...
function animateValue({ start = 0, end = 100, duration = 1000, delay = 0, ease = easeOutCubic, onUpdate, onEnd }: AnimateOptions): void {
...
/**
 * 指针靠近卡片边缘时点亮的流光亮边：外层光晕 + 网格渐变描边 + 边缘底色。
 * 移植自 React Bits 的 BorderGlow（JS + CSS 版本），改成 TSX 并补类型。
 */
